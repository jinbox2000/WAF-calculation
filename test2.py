...
def process_file(fil):
    ...
    try:
        ...
        # COORDINATES
        #
        # Your coordinates are degrees:
        #
        #     lat = 0.5, 1.5, ...
        #     lon = 0.5, 1.5, ...
        #
        # Therefore derivatives with respect to the
        # coordinate require pi / 180.
        # ====================================================
        ...
        #     psi' = g Z' / f
        #
        # Z3 is assumed to be geopotential height [m].
        # ====================================================
        ...
        # ====================================================
        # PHYSICAL HORIZONTAL DERIVATIVES
        #
        # x = a cos(phi) lambda
        # y = a phi
        #
        # lon and lat coordinates are degrees.
        #
        # Therefore:
        #
        # d/dx =
        ...
        # where
        #
        #     Txx = psi_x^2 - psi psi_xx
        #     Txy = psi_x psi_y - psi psi_xy
        #     Tyy = psi_y^2 - psi psi_yy
        #
        # This is the horizontal TN1997 tensor form.
        # ====================================================
